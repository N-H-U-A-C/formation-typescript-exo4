...
const contact1: Contact = new Contact(Title.Mr, "Smith", "Agent", new Date("1985/01/05"), "+33796584128", "welcome@intothematrix.com");
const contact2: Contact = new Contact(Title.Mme, "Doe", "Jane", new Date("1995/05/05"), "+3367419635", "jane@doe.com");
